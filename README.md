# KNAN — ระบบติดตามงานนักเรียน (เว็บแอป + Firebase)

โลโก้แอปอยู่ที่โฟลเดอร์ `assets/` (logo.svg และไฟล์ไอคอนขนาดต่างๆ) **ต้องอัปโหลดทั้งโฟลเดอร์ `assets/` ขึ้น GitHub ไปพร้อมกับ index.html ด้วย** ไม่งั้นโลโก้และไอคอนจะไม่ขึ้น
